/**
 * List of splash screen images for Apple Web App (PWA)
 * */
export const APPLE_SPLASH_IMAGES = [
  {
  ...
  {
    url: '/icons/apple-splash-1488-2266.png',
    media:
      '(device-width: 744px) and (device-height: 1133px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)'
  },
  {
    url: '/icons/apple-splash-2266-1488.png',
    media:
      '(device-width: 744px) and (device-height: 1133px) and (-webkit-device-pixel-ratio: 2) and (orientation: landscape)'
  },
  {
    url: '/icons/apple-splash-1640-2360.png',
    media:
      '(device-width: 820px) and (device-height: 1180px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)'
  },
  {
    url: '/icons/apple-splash-2360-1640.png',
    media:
